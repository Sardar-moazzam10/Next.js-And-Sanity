...
export default async function Home() {
  return (
    <div className="text-black ">
     ...
     <div className=" flex justify-center items-center font-serif "><h1>Blog Website With Sanity And Next Js</h1></div>
